        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ action('MaterialController@store') }}">
                            {!! csrf_field() !!}
                            ...
                            <div class="input-field col s6">
                                ...
                                <textarea class="validate" name="description" id="description" >{{ $description or old('description') }}</textarea>
                            ...
                            <div class="input-field col s6">
                                ...
                                <input type="text" class="validate" name="quantity" id="quantity"
                                       value="{{ $quantity or old('quantity') }}" />
